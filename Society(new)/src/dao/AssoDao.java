...
//            asso.setAssociationId(assoid);
    ...
    public Association addAsso(Association asso) throws BusinessException, SQLException, DbException {
        Connection conn = null;
        int assoid = 0;
        try {
    ...
    /*
     * 没测试过的delasso*/
    public void delAsso(int assoid) throws SQLException, DbException {
        Connection conn = null;
        try {
            conn = this.getConnection();
