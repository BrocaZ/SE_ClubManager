...
public class ActManager {
   ...
   public static void modAct(Activity act) throws BaseException {//修改社团信息     社长在社团活动后面点击修改信息   地点采用下拉框选择名称的形式   活动内容，负责人学号，可参加人数等等采用输入的形式     开始时间，结束时间采用时间选择的形式   
	...
	public static void addAct(Activity act) throws BaseException {//社长点击增加活动    与修改活动信息界面一致
