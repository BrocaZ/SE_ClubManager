...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled">
            ...
            <li class="active"><a href="resetPassword.jsp"> <i class="icon-user"></i>密码重置</a></li>
        </ul>
    </nav>
    ...
    <div class="page-content">
        <div class="page-header">
            <div class="container-fluid">
                <h2 class="h5 no-margin-bottom">密码重置</h2>
            </div>
        </div>
        <div class="apply" style="padding-top: 50px; padding-left:200px;padding-bottom: 100px;">
            <form  action="${pageContext.request.contextPath}/resetPassword" method="post" style="text-align: center">
                <div class="apply1">
                    <label class="apply-control-label">学号</label>
                    <input type="text" class="apply-control" style="width: 200px" name="sno">
                </div>
